...
//   waitFor(5);  => waits for 5 second => Thread.sleep(5000)
    ...
    public enum ClickType {
        ...
        DOUBLE,        // double click
        ENTER_KEY      // Enter tuşu ilə click
    }

    public static void clickElement(WebElement element, ClickType type) {
        Actions actions = new Actions(Driver.getDriver());
        try {
            switch (type) {
                case DEFAULT:
            ...
            System.out.println(type + " ilə uğurlu klik edildi");
        } catch (Exception e) {
            System.out.println(type + " ilə klikləmə uğursuz oldu: " + e.getMessage());
        }
    }
